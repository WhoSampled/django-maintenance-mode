...
MAINTENANCE_MODE_EXPIRE_DB_SESSIONS = getattr(settings, 'MAINTENANCE_MODE_EXPIRE_DB_SESSIONS', False)
MAINTENANCE_MODE_GET_CLIENT_IP_ADDRESS = getattr(settings, 'MAINTENANCE_MODE_GET_CLIENT_IP_ADDRESS', None)
MAINTENANCE_MODE_GET_TEMPLATE_CONTEXT = getattr(settings, 'MAINTENANCE_MODE_GET_TEMPLATE_CONTEXT', None)
...
MAINTENANCE_MODE_IGNORE_ANONYMOUS = getattr(settings, 'MAINTENANCE_MODE_IGNORE_ANONYMOUS', False)
MAINTENANCE_MODE_IGNORE_TESTS = getattr(settings, 'MAINTENANCE_MODE_IGNORE_TESTS', False)
